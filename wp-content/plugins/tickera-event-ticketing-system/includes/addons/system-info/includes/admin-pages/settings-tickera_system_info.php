                ...
                <div class="inside">
                    ...
                    <table class="form-table" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <?php
                                $mark_allow_url_include = @ini_get('allow_url_include') ? 'yes' : 'error';
                                ?>
                                <td><?php _e('allow_url_include', 'tc'); ?>:</td>
                                <td class="help"><?php echo tc_tooltip(__('Ticket template might need allow_url_include to be allowed on your server in order to retrieve images.', 'tc')); ?></td>
                                <td>
                                    <mark class="<?php echo $mark_allow_url_include; ?>">
                                        <?php echo ini_get('allow_url_include') ? '<span class="dashicons dashicons-yes"></span>' : '<span class="dashicons dashicons-info"></span> ' . __('Ask your hosting provider to turn on allow_url_include option if you\'re experiencing issues with opening / downloading PDF tickets.', 'tc'); ?>
                                    </mark>
                                </td>
                            </tr>
                            <?php
